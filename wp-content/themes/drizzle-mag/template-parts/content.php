...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<div class="article-wrapper">
		...
		<div class="entry-content">
			<?php $archive_layout = drizzle_mag_get_option( 'archive_layout' ); ?>

			<?php if ( 'full' === $archive_layout ) : ?>
				<?php
				the_content( sprintf(
					/* translators: %s: Name of current post. */
					wp_kses( __( 'Continue reading %s <span class="meta-nav">&rarr;</span>', 'drizzle-mag' ), array( 'span' => array( 'class' => array() ) ) ),
